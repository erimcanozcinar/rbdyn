...
int main(int argc, char** argv) {   
    ...
    auto robot = world.addArticulatedSystem("/home/erim/rbdyn/examples/rsc/go2/urdf/go2_gazebo.urdf");
    /* #endregion */
    ...
    while (1) {
        ...
        refQ = robotModel.inverseKinematic({robotModel.getFrameID("LF_foot_fixed"),
                                     robotModel.getFrameID("RF_foot_fixed"),
                                     robotModel.getFrameID("LH_foot_fixed"),
                                     robotModel.getFrameID("RH_foot_fixed")}, 
        ...
        robotModel.applyExternalForce(robotModel.getBodyID("LF_FOOT"), Fex_FL);
        robotModel.applyExternalForce(robotModel.getBodyID("RF_FOOT"), Fex_FR);
        robotModel.applyExternalForce(robotModel.getBodyID("LH_FOOT"), Fex_RL);
        robotModel.applyExternalForce(robotModel.getBodyID("RH_FOOT"), Fex_RR);
