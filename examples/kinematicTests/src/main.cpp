...
int main(int argc, char** argv) {   
    ...
    while (1) {
        ...
        RSINFO(jac)
        RSWARN(robotModel.pointJacobian(robotModel.getFrameID("Joint6"),robotState));
        std::cout << "-----------------------" << std::endl;
        /* #endregion */
        ...
        Qik = robotModel.inverseKinematic({robotModel.getFrameID("Joint3"), robotModel.getFrameID("Joint6")}, {refPosL, refPosR}, genCoordinates, robotState.basePosition, robotState.baseR);
